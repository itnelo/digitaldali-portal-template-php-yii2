...
return [
    ...
    'Account settings' => 'Настройки личного кабинета',
    'Private settings' => 'Регистрационные данные',/*custom*/
    'Private settings change' => 'Изменение регистрационных данных',/*custom*/
    ...
    /*custom*/
    'Your account has been created and a message with further instructions has been sent to your email' => 'Аккаунт успешно создан, на Ваш email отправлено письмо со ссылкой для подтверждения регистрации',
    'Welcome to {0}' => 'Добро пожаловать на портал по обучению русскому языку!',
    'Your account on {0} has been created' => 'Ваш аккаунт на портале по обучению русскому языку успешно создан',
    'We have received a request to change the email address for your account on {0}' => 'Вы запросили смену email на портале по обучению русскому языку',
    'We have received a request to reset the password for your account on {0}' => 'Вы запросили смену пароля на портале по обучению русскому языку',
    'Thank you for signing up on {0}' => 'Спасибо за регистрацию на портале по обучению русскому языку',
    'Complete password reset on {0}' => 'Смена пароля на портале по обучению русскому языку',
    'Confirm account on {0}' => 'Подтверждение регистрации на портале по обучению русскому языку',
    'Confirm email change on {0}' => 'Смена почтового адреса на портале по обучению русскому языку',
    'Please complete filling profile info' => 'Пожалуйста, завершите заполнение своего профиля!',
    'Thank you, registration is now complete.' => 'Ваш аккаунт был успешно подтвержден.',
    'In order to complete your registration, please click the link below' => 'Для подтверждения регистрации перейдите, пожалуйста, по ссылке ниже',
];
